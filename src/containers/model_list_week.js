...
class _ModelListWeek extends Component {
    constructor(props) {
        super(props);
...
const ModelListWeek = connect(mapStateToProps, mapDispatchToProps)(_ModelListWeek);
export default ModelListWeek;